...
public class SyncAsyncOnlinePlayersData {
    @Getter private final LinkedMapList<Pair<String, UUID>, PlayerData> playerData = new LinkedMapList<>();
    @Getter private CompletableFuture<Map<Pair<String, UUID>, Triplet<String, Map<String, String>, Integer>>> syncFuture;
